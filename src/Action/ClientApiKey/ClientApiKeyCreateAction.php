...
final class ClientApiKeyCreateAction
{
  ...
  public function __invoke(ServerRequestInterface $request, ResponseInterface $response): ResponseInterface
  {
    ...
    $apikey = $this->service->create($data);
    return $this->renderer->response($response, ['message' => 'API Key generated successfully.', 'api_key' => $apikey])->withStatus(StatusCodeInterface::STATUS_OK);
  }
}
